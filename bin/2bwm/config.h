...
static const char *colors[] = { "#f0f0f0", "#f0f0f0", "#f0f0f0", "#333b3e", "#343f3f", "#f0f0f0", "#f0f0f0", "#f0f0f0" };
...
static const char *ignore_names[] = {"bar", "xclock", "google-chrome", "no-title", "mpv", "Telegram", "Spacefm", "spacefm", "TelegramDesktop", "telegram-desktop"};
///--Menus and Programs---///
