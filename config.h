 ...
 */
static char *font = "UbuntuMono Nerd Font:size=10.5:antialias=true:autohint=false";
static char *font2[] = { "UbuntuMono Nerd Font:size=10.5:antialias=true:autohint=false" };
